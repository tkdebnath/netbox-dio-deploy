...
class TestDocstringCoverage:
    ...
    def test_classes_have_docstring_with_parameters_section(self, all_classes: Dict[str, type]) -> None:
        ...
        """
        # Classes where __init__ is auto-generated by Pydantic or dataclasses
        ...
        pydantic_model_classes = {
            ...
            "CacheMetrics",
            # Abstract base classes and concrete backends (use from_env() factory)
            "CacheBackend", "RedisCacheBackend", "InMemoryCacheBackend",
            # Progress managers (use from_env() factory)
